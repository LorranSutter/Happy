...
export default function OrphanageDetails() {
  ...
  function handleOpenGoogleMapsDirections() {
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.mapContainer}>
          ...
          <TouchableOpacity onPress={handleOpenGoogleMapsDirections} style={styles.routesContainer}>
            <Text style={styles.routesText}>See directions on Google</Text>
          </TouchableOpacity>
        </View>
          ...
          {orphanage.open_on_weekends ? (
            <View style={[styles.scheduleItem, styles.scheduleItemGreen]}>
              ...
              <View style={[styles.scheduleItem, styles.scheduleItemRed]}>
                <Feather name="info" size={40} color="#FF66D9" />
                <Text style={[styles.scheduleText, styles.scheduleTextRed]}>We are not open on weekends</Text>
              </View>
            )}
        ...
        {/* <RectButton style={styles.contactButton} onPress={() => { }}>
          ...
          <Text style={styles.contactButtonText}>Keep in touch</Text>
        </RectButton> */}
      </View>
    </ScrollView>
  )
